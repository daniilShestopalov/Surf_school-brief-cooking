...
| Ошибка сети | Отсутствует подключение к сети |
| Ошибка 5xx | Сервис временно недоступен. Попробуйте позже |
| Ошибка 429 | Блокировка повторной отправки, синхронизация таймера интерфейса с заголовком ответа `Retry-After` |
...
|------------|----------|----------|
| 429 Too Many Requests | Отправка или проверка кода | Блокировка повторной отправки, синхронизация таймера интерфейса с заголовком ответа `Retry-After` |
| NETWORK_ERR | Отправка или проверка кода | Системный алерт "Отсутствует подключение к сети" |
| 5xx Server Error | Отправка или проверка кода | Системный алерт "Сервис временно недоступен. Попробуйте позже" |
