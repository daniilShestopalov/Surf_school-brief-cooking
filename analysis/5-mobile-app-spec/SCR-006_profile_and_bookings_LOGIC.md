...
| 5xx Server Error | Загрузка данных | Системный алерт "Сервис временно недоступен. Попробуйте позже" |
| NETWORK_ERR | Загрузка данных | Системный алерт "Отсутствует подключение к сети" (если кэш пуст — Error State на месте списков) |
